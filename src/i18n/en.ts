...
const en = {
  ...
  'toast': {
    ...
    'confirm': 'Confirm',
    'cancel': 'Cancel',
    'quit_room': 'Are you sure to you want to exit the videocall?',
    'kick': 'kicked',
    'login_failure': 'login failure',
    'whiteboard_lock': 'Whiteboard follow',
    'whiteboard_unlock': 'Whiteboard nofollow',
    'canceled_screen_share': 'Stopped screen sharing',
    ...
    'teacher_exists': 'Admin already exists, Please waiting for 30s or reopen new class',
    'student_over_limit': 'Student have reached upper limit, , Please waiting for 30s or rejoin new class',
    'teacher_and_student_over_limit': 'The number of participants has reached upper limit',
    'teacher_accept_whiteboard': 'Admin already grant your whiteboard',
    'teacher_cancel_whiteboard': 'Admin already cancel your whiteboard',
    'teacher_accept_co_video': 'Admin already accept co-video',
    'teacher_reject_co_video': 'Admin already rejected co-video',
    'teacher_cancel_co_video': 'Admin already canceled co-video',
